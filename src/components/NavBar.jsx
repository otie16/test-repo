        ...
        <nav
          className={
            isOpen
              ...
              : "hidden sm:flex align-items justify-around px-4 py-3"
          }
        >
          {user ? (
            <Link
              to="/service-request"
              className="block px-6 py-2 font-semibold rounded hover:bg-gray-200 hover:rounded-full sm:mr-3 sm:mt-0"
            >
              Request for Service
            </Link>
          ) : (
